...
export default function StudentPage() {
    ...
    function row(dis) {
        ...
        directionTd.setAttribute("style", "padding:5px; text-align: center");
        directionTd.append(dis.direction[0].name);
        ...
        <div className={classes.root}>
            <form noValidate name="disForm">
                <Autocomplete className={classes.select1}
                              id="direction"
                              renderInput={(params) =>
                                  <TextField {...params} label="Направление" variant="standard" />}
                              onClick={Dis2()}
                              options={zap2}
                              onChange={(event, value) =>
                                  setForm({ ...form, idDirection: value.id,  direction: value})}
